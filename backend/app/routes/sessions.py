    ...
    clusters_data = [
        {
            ...
            "summary": "Multiple students are struggling with the DGIM algorithm — specifically how buckets work, the merging rules (at most 2 buckets of each size), and why the error bound is 50% for the oldest bucket.",
            "upvotes": 14,
            "on_topic": True,
        },
        {
            ...
            "summary": "Students are asking about the practical memory requirements of sliding windows and the tradeoffs between count-based vs time-based window approaches.",
            "upvotes": 9,
            "on_topic": True,
        },
        {
            ...
            "summary": "Students want to understand why Bloom filters can have false positives but never false negatives, and how to choose the optimal number of hash functions.",
            "upvotes": 7,
            "on_topic": True,
        },
        {
            ...
            "summary": "Students are confused about how reservoir sampling maintains equal probability for each element when the stream is potentially infinite — when do you stop sampling?",
            "upvotes": 5,
            "on_topic": True,
        },
        {
            ...
            "summary": "Several students have logistical questions about the final exam scope, office hours schedule, and whether lecture slides will be posted.",
            "upvotes": 2,
            "on_topic": False,
        },
    ]
